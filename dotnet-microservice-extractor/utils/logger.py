...
def setup_logging():
    ...
    # === Separate LLM Logger ===
    llm_log_file = settings.logs_dir / "llm_responses.log"
...
logger, llm_logger = setup_logging()
...
__all__ = ['logger', 'llm_logger', 'debug', 'info', 'warning', 'error', 'critical']